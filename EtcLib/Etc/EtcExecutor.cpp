...
namespace Etc {
	...
	Executor::EncodingStatus Executor::Encode(Format a_format, ErrorMetric a_errormetric, float a_fEffort, unsigned int a_uiJobs, unsigned int a_uiMaxJobs)
	{
		...
		auto status = EncodeSteps(a_format, a_errormetric, a_fEffort, a_uiJobs, a_uiMaxJobs);
	...
	Executor::EncodingStatus Executor::EncodeSteps(Format const a_format, ErrorMetric const a_errormetric, float const a_fEffort, unsigned int a_uiJobs, unsigned int const a_uiMaxJobs)
	{
